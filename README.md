...
```
 1. Распоковать файл flutter_windows_3.3.7-stable в C:\src\flutter
```
##### Переменные среды Windows
```
 1. Win + R и ввести в поле run sysdm.cpl
 ...
 4. Добавить в строчку C:\src\flutter\bin и нажать ОК и еще раз ОК
```
#### Команда flutter doctor
```
 1. Вести в компандную строку терминала flutter doctor
 2. После того как команда отработает появится список проблем (может и появиться, если все ноебходимое стоит).
```
